...
export default function About() {
  return (
    <section id="about" className="bg-[#223550] py-4  xl:px-20 xl:h-[90%]">
      <div className="profile flex flex-wrap-reverse sm:flex-nowrap lg:h-[28rem]">
        ...
        <div className="info sm:w-[55%] m-2 sm:m-2 mt-24  bg-[#0d1321] p-6 sm:p-6 pt-24  rounded-3xl ">
          ...
          <p className=" py-6 sm:pr-12  opacity-75 font-medium text-sm sm:text-base">
            ...
            eaque magnam necessitatibus vitae?
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa
            architecto, velit excepturi doloremque commodi eveniet minus optio.
            Dolore, perferendis, est mollitia aperiam aspernatur a placeat at
            eaque magnam necessitatibus vitae?
      ...
      {/* <span className='bg-orange-500 h-4 w-1 absolute top-2 left-2 '></span>
      <span className='bg-orange-500 h-1 w-10 absolute top-3 left-4 '></span> */}
      {/* <span className='bg-gray-500 h-4 w-4 absolute top-5 left-6 opacity-70'></span> */}
      {/* <span className='border border-solid border-orange-700 h-4 w-4 absolute top-6 left-7 opacity-70'></span>
      <span className='border border-solid border-gray-700 h-4 w-4 absolute top-7 left-8 opacity-70'></span>
      <span className='border border-solid border-gray-700 h-12 w-12 absolute top-8 left-9 opacity-70'></span> */}
      {/* <span className='bg-gray-700 h-4 w-4 absolute top-9 left-10 opacity-70'></span>
      <span className='bg-orange-500 h-1 w-4 absolute top-10 left-11 opacity-70'></span> */}
      {/* <span className='bg-orange-500 h-5 w-5 absolute top-11 left-[22rem] '></span> */}
      ...
      <span className=' h-16 w-10 absolute -top-[12rem] left-72 rounded-r-full bg-gray-600 opacity-85 rotate-45'></span>
          ...
          {/* <span className="img overflow-hidden p-2  rounded-full"> */}
            <img
              src={profile}
      ...
      <div className="contact flex  justify-evenly">
        <a href="https://www.linkedin.com/feed/" target="_blank" className="bg-[#0d1321] rounded-xl py-4 w-[31%] xl:w-[32%] text-base font-medium border-solid border border-gray-700 sm:flex justify-center hidden ">Linkedin</a>
        <a href="https://github.com/dibaya07" target="_blank" className="bg-[#0d1321] rounded-xl py-4 w-[31%] xl:w-[32%] text-base font-medium border-solid border border-gray-700 sm:flex justify-center hidden ">github</a>
        <a href="https://www.instagram.com/a" target="_blank" className="bg-[#0d1321] rounded-xl py-4 w-[31%] xl:w-[32%] text-base font-medium border-solid border border-gray-700 sm:flex justify-center hidden ">Instagram</a>
        </div>
    </section>
  );
}
