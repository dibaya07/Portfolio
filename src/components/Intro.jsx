...
export default function Intro() {
  return (
    <section id='home' className='text-center bg-[#02080f] h-full sm:py-8 py-4 mt-20'>
      ...
      <span className='border-solid border border-gray-500 py-1 px-4 rounded-full tracking-widest text-sm font-medium inline-block my-6'>WEB DEVELOPER</span>
      ...
      <div className="btns sm:hidden py-8 px-4">
        ...
        <button className="bg-[#0d1321] sm:hidden rounded-xl py-4 px-5 sm:px-40 text-4xl font-medium border-solid border border-gray-700 m-2"><FaLinkedin /></button>
        <button className="bg-[#0d1321] sm:hidden rounded-xl py-4 px-5 sm:px-40 text-4xl font-medium border-solid border border-gray-700 m-2"><FaSquareGithub /></button>
        <button className="bg-[#0d1321] sm:hidden rounded-xl py-4 px-5 sm:px-40 text-4xl font-medium border-solid border border-gray-700 m-2"><FaSquareInstagram /></button>
